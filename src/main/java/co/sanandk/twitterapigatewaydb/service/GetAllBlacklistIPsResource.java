 ...
 * @author SAnanda
 */
@Path("GetAllBlacklistIPs")
public class GetAllBlacklistIPsResource {

    @Context
    private UriInfo context;

    /**
     * Creates a new instance of GetAllBlacklistIPsResource
     */
    public GetAllBlacklistIPsResource() {
    }

    /**
     * Retrieves representation of an instance of co.sanandk.twitterapigatewaydb.service.GetAllBlacklistIPsResource
    ...
    em.getTransaction().begin();
        ...
        List<Blacklistips> list = cf.findAll();
    ...
    /**
     * PUT method for updating or creating an instance of GetAllBlacklistIPsResource
